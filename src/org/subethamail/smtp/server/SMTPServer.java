...
{
	private final static Logger log = Logger.getLogger(SMTPServer.class);
	...
	public synchronized void start()
	{
		if (this.isLogger())
		{
			log.info("SMTP server "+getDisplayableLocalSocketAddress()+" starting");
		}
	...
	public synchronized void stop()
	{
		if (this.isLogger())
		{
			log.info("SMTP server "+getDisplayableLocalSocketAddress()+" stopping");
		}
