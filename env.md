...
```bash
echo 'export OTPPI_ACTIVATION_AUTHORIZATION="Basic"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_CONTENT_TYPE="application/json"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_METHOD="POST"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_PASSWORD="password"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_REQUEST_TIMEOUT="30000"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_URL="http://localhost/Universal-REST-Simulator/activation"' >> $HOME/.bashrc
echo 'export OTPPI_ACTIVATION_USERNAME="username"' >> $HOME/.bashrc
...
echo 'export OTPPI_CRON_ENABLE_MQTT="true"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_ENABLE_NTP="true"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_ENABLE_REDIS="true"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_ENABLE_SERVER_STATUS="true"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_ENABLE_WS="true"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_AMQP="0 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_DEVICE="0 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_GENERAL="*/10 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_MQTT="0 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_REDIS="0 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_SERVER_STATUS="0 */5 * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_EXPRESSION_WS="0 * * * * ?"' >> $HOME/.bashrc
echo 'export OTPPI_CRON_TIME_RESOLUTION="minute"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_BLOCKING="/api/blocking"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_EMAIL="/api/email"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_MESSAGE="/api/message"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_OTP="/api/otp"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_SMS="/api/message"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_API_PATH_UNBLOCKING="/api/unblocking"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_HTTPS_ENABLE="false"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_HTTPS_PORT="443"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_HTTP_ENABLE="true"' >> $HOME/.bashrc
echo 'export OTPPI_DEFAULT_HTTP_PORT="80"' >> $HOME/.bashrc
...
echo 'export OTPPI_HWCLOCK="hwclock"' >> $HOME/.bashrc
...
echo 'export OTPPI_PATH_SETTING_ALL="/resource/config/config.iniW"' >> $HOME/.bashrc
...
echo 'export OTPPI_PATH_SETTING_SUBSCRIBER_ACTIVEMQ="/resource/data/subscriber/subscriber-activemq.json"' >> $HOME/.bashrc
...
echo 'export OTPPI_PATH_SETTING_SUBSCRIBER_STOMP="/resource/data/subscriber/subscriber-stomp.json"' >> $HOME/.bashrc
...
echo 'export OTPPI_SERVER_STATUS_MAX_RECORD="1000"' >> $HOME/.bashrc
